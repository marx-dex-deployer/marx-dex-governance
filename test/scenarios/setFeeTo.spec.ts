...
describe('scenario:setFeeTo', () => {
  ...
  beforeEach('deploy MarXDEX v2', async () => {
    factory = await deployContract(wallet, MarXDEXV2Factory, [timelock.address])
  })
  ...
  it('setFeeTo', async () => {
    ...
    const description = 'Set feeTo on the MarXDEXV2Factory to the timelock address.'

    // activate balances
    await marx.delegate(wallet.address)
